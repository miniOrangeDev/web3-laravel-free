...
class CustomerDetails
{
    ...
    {
        try {
            $result = LaraDB::select('select * from mo_web3_customer_details where mo_web3_domain_name = ?', [self::web3_get_current_domain()]);
            if( count($result) == 0 ) {
    ...
    {
        try {
            $result = LaraDB::table('mo_web3_customer_details')->updateOrInsert([
    ...
    public static function web3_get_current_domain()
    {
