                    ...
                    <div class="col-lg-10">
                        <form method="post" action="">
                            ...
                            <input type="hidden" name="option"
                                   value="mo_web3_contact_us_query_option"/>
                            <div class="form-group">
                                <input class="form-control" type="email"
                                       name="mo_web3_contact_us_email" placeholder="Enter your email"
                                       required
                                       value="<?php echo CD::get_option('mo_web3_admin_email');?>">
                            </div>
                            <div class="form-group">
                                <input class="form-control" type="tel"
                                       name="mo_web3_contact_us_phone" required
                                       pattern="[\+]\d{11,14}|[\+]\d{1,4}[\s]\d{9,10}"
                                       placeholder="We call only if you do. 	( eg.+1 9876543210, +91 1234567890 )">
                            </div>
                            <div class="form-group">
								<textarea class="form-control" name="mo_web3_contact_us_query"
                                          required placeholder="Enter your query here"
                                          onkeypress="mo_web3_valid_query(this)"
                                          onkeyup="mo_web3_valid_query(this)"
                                          onblur="mo_web3_valid_query(this)"></textarea>
                            </div>
